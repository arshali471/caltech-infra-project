...
output "oracle_plugin_arn" {
  description = "Custom plugin ARN used by the empty-schema Oracle connector (null when disabled)"
  value       = one(module.msk_connect_oracle_empty_schema[*].plugin_arn)
}

output "oracle_connector_arn" {
  description = "ARN of the empty-schema Oracle connector (null when disabled)"
  value       = one(module.msk_connect_oracle_empty_schema[*].connector_arn)
}
